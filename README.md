...
If you want InventoryItemAggregateRoot as immutable, you may use [Lenses for Java](https://github.com/remeniuk/java-lenses/blob/master/examples/src/main/java/PersonZipCodeExample.java) when updating it. 
